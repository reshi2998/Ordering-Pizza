...
<html>
    ...
    <body>
        <header>
            <h2>Ingrese el código de una pizza</h2>
            <div class = "fechas">
                <form method="POST" action="ServicioProductos">
                    <input type="text" id="producto" name="producto" size="25"/>
            ...
            <section id="sec4">
                <table class="tablaPizzas">
                    ...
                    <%
                        ...
                        String fei = request.getParameter("idP");
                        if (fei != null) {
                    %>
